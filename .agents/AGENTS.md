...
4. Use the ClickUp API config stored in `clickup-config.json` at the project root.
5. The ClickUp space is **CMS** and the folder is **2026 Support Team** by default, but always confirm if the user wants a different path.
