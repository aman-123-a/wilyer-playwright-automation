...
- Name: _core\widgets\eta\eta-widget.spec.ts >> Live ETA widget — BVA @boundary >> ETA-035-lat-absurd coordinate boundary: latitude far out of range
- Location: tests\_core\widgets\eta\eta-widget.spec.ts:447:5

# Error details

```
Error: latitude far out of range must be rejected
