...
- Name: _core\widgets\eta\eta-widget.spec.ts >> Live ETA widget — negative @negative >> ETA-055-object-coords malformed coordinates are rejected
- Location: tests\_core\widgets\eta\eta-widget.spec.ts:577:5

# Error details

```
Error: object-coords must not be stored
