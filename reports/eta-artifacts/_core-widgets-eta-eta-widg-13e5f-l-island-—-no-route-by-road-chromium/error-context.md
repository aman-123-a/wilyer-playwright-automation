...
- Name: _core\widgets\eta\eta-widget.spec.ts >> Live ETA widget — BVA @boundary >> ETA-035-zero-island coordinate boundary: null island — no route by road
- Location: tests\_core\widgets\eta\eta-widget.spec.ts:447:5

# Error details

```
Error: null island — no route by road must be rejected
