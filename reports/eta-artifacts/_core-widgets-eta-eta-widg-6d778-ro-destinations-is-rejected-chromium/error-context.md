...
- Name: _core\widgets\eta\eta-widget.spec.ts >> Live ETA widget — BVA @boundary >> ETA-036 zero destinations is rejected
- Location: tests\_core\widgets\eta\eta-widget.spec.ts:463:3
