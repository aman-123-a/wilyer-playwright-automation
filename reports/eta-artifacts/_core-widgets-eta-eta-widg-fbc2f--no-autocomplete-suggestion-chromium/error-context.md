...
- Name: _core\widgets\eta\eta-widget.spec.ts >> Live ETA widget — negative @negative >> ETA-057 gibberish location yields no autocomplete suggestion
- Location: tests\_core\widgets\eta\eta-widget.spec.ts:602:3

# Error details

```
Error: an unresolvable string must not offer a place to select
