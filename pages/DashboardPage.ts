...
//   • Panels: "Screen / Players" recent table + "Screens Location" Google map.
// =============================================================================
...
export class DashboardPage extends BasePage {
  ...
  readonly recentScreensTable: Locator;
  ...
  constructor(page: BasePage['page']) {
    ...
    // Stat cards are anchor cards each containing a <h3> value + <h6> label.
    this.statCards = page.locator('a').filter({ has: page.locator('h3') });
    this.recentScreensTable = page.getByRole('table').first();
